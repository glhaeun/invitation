...
@media (max-width: 768px) {
  .carousel .item {
    margin-inline: 0; /* Remove horizontal margin for smaller screens */
  }
}
...
<div class="cont">
    <aside class="carousel">
      <div class="carousel__wrapper">
        <div class="item" id="slide-0"><img src="https://assets.codepen.io/108082/jake-and-fin-1.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-1"><img src="https://assets.codepen.io/108082/jake-and-fin-2.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-2"><img src="https://assets.codepen.io/108082/jake-and-fin-3.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-3"><img src="https://assets.codepen.io/108082/jake-and-fin-4.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-4"><img src="https://assets.codepen.io/108082/jake-and-fin-5.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-5"><img src="https://assets.codepen.io/108082/jake-and-fin-6.jpg" alt="" width="418" height="418"/></div>
        <div class="item" id="slide-6"><img src="https://assets.codepen.io/108082/jake-and-fin-7.jpg" alt="" width="418" height="418"/></div>
      </div>
    </aside>
